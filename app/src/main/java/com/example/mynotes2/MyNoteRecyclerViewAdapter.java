...
import com.example.mynotes2.placeholder.PlaceholderContent.PlaceholderItem;
import com.example.mynotes2.databinding.FragmentNoteBinding;
...
public class MyNoteRecyclerViewAdapter extends RecyclerView.Adapter<MyNoteRecyclerViewAdapter.ViewHolder> {
    ...
    private final NoteFragment.OnNoteListInteractionListener mListener; public
    MyNoteRecyclerViewAdapter(List < Note > notes, NoteFragment.OnNoteListInteractionListener listener)
    {
        mValues = notes;
        mListener = listener;
    }
